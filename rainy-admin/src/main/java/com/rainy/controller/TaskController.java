...
public class TaskController {
    ...
    @SysLog(module = "定时任务", operationTypeCode = OperationType.QUERY, detail = "'查询了任务列表第' + #page.current + '页.每页' + #page.size + '条数据'")
    @GetMapping("/tasks")
    ...
    @SysLog(module = "定时任务", operationTypeCode = OperationType.EXPORT, detail = "导出了定时任务列表", saved = false, paramSaved = false)
    ...
    @ApiOperation("新增任务")
    @SysLog(module = "定时任务", operationTypeCode = OperationType.ADD, detail = "'新增了任务[' + #task.name + '].'")
    ...
    @ApiOperation("删除任务")
    @SysLog(module = "定时任务", operationTypeCode = OperationType.DELETE, detail = "'删除了任务[' + #dto.name + '].'")
    @DeleteMapping("/task")
    ...
    @ApiOperation("批量删除任务")
    @SysLog(module = "定时任务", operationTypeCode = OperationType.DELETE, detail = "'批量删除了任务[' + #dto.names + '].'")
    @DeleteMapping("/tasks")
    ...
    @ApiOperation("更新任务")
    @SysLog(module = "定时任务", operationTypeCode = OperationType.UPDATE, detail = "'更新了任务[' + #task.name + '].'")
    ...
    @ApiOperation("暂停任务")
    @SysLog(module = "定时任务", operationTypeCode = OperationType.UPDATE, detail = "'暂停了任务[' + #dto.name + '].'")
    ...
    @ApiOperation("恢复任务")
    @SysLog(module = "定时任务", operationTypeCode = OperationType.UPDATE, detail = "'恢复了任务[' + #dto.name + '].'")
