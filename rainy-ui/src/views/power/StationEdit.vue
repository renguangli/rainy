    ...
    <a-spin :spinning="formLoading">
      <a-form :form="form" >
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-input placeholder="请输入场站名称" v-decorator="['name',{rules: [{required: true, min: 1, message: '请输入场站名称！'}]}]" />
        </a-form-item>
        <a-form-item
          label="场站名称"
          :labelCol="labelCol"
          ...
          hasFeedback
        >
          <a-input placeholder="请输入场站编码" v-decorator="['code',{rules: [{required: true, min: 1, message: '请输入场站名称！'}]}]" />
        </a-form-item>
        <a-form-item
          label="父级场站"
          :labelCol="labelCol"
        ...
        >
          <a-tree-select
            v-decorator="['parentId', {rules: [{ required: true, message: '请选择父级场站！' }]}]"
            style="width: 100%"
...
<script>
  import { ListTree, Add, Edit } from '@/api/resource'
  export default {
    name: 'StationEdit',
    data () {
      return {
