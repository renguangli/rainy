    ...
    <a-spin :spinning="formLoading">
      <a-form :form="form" >
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-select placeholder="请选择数据类型" v-decorator="['dataType',{rules: [{required: true, min: 1, message: '请选择数据类型！'}]}]">
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-input placeholder="请输入值" v-decorator="['value',{rules: [{required: true, min: 1, message: '请输入值！'}]}]" />
        </a-form-item>
        <a-form-item
          label="描述"
          :labelCol="labelCol"
