    ...
    <a-spin :spinning="formLoading">
      <a-form :form="form" >
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-input placeholder="请输入字典名称" v-decorator="['name',{rules: [{required: true, min: 1, message: '请输入字典名称！'}]}]" />
        </a-form-item>
        <a-form-item
          label="唯一编码"
          :labelCol="labelCol"
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-select placeholder="请选择字典分类" v-decorator="['categoryCode',{rules: [{required: true, min: 1, message: '请选择字典分类！'}]}]">
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-select placeholder="请选择数据类型" v-decorator="['type',{rules: [{required: true, min: 1, message: '请选择数据类型！'}]}]">
    ...
    methods: {
      ...
      open (flag, record) {
        ...
        if (flag !== 0) {
          ...
          this.form.getFieldDecorator('type', { initialValue: record.type })
