<template>
  <div class="main">
    ...
    >
      ...
      >
        <a-tab-pane key="tab1" :tab="$t('user.login.tab-login-credentials')">
          <a-alert v-if="isLoginError" type="error" showIcon style="margin-bottom: 24px;" :message="loginFailedMessage" />
          <a-form-item>
            <a-input
              size="large"
              type="text"
    ...
    <Verify
      ref="verify"
      :captcha-type="new Date().getSeconds() % 2 === 0 ? 'clickWord': 'blockPuzzle'"
...
export default {
  ...
  methods: {
    ...
    handleSubmit (e) {
      e.preventDefault()
      if (this.requiredTwoStepCaptcha) {
